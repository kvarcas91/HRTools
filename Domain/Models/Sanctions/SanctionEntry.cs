...
{
    public struct SanctionEntry : IDataImportObject, IWritable
    {
        ...
        {
            return "EmployeeID,UserID,EmployeeName,Shift,Manager,MeetingType,Sanction,SanctionStartDate,SanctionEndDate,CreatedBy,CreatedAt,Overriden,OverridenBy,OverridenAt";
        }
        ...
        public SanctionEntry SetEmployee(IEmployee empl)
        {
        ...
        public SanctionEntry SetEmployee(CustomMeetingEntity empl)
        {
        ...
        public SanctionEntry SetSanction(string sanction, DateTime startDate)
        {
            Sanction = sanction;
